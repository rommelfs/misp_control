...
# get release version
#VERSION_RELEASE=$( curl -s -I https://github.com/MISP/MISP/releases/latest |grep location |head -n 8|ggrep -oP '/MISP/MISP/releases/tag/\Kv[0-9]+\.[0-9]+\.[0-9]+' | rev | cut -d "/" -f 1|rev|cut -d "v" -f 2 )
